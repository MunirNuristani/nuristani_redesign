...
import { AppReducer, createInitialState, AppState, AppAction, Language } from './Reducer';
...
export function ReducerWrapper({ children, initialLocale }: ReducerWrapperProps) {
    const [state, dispatch] = useReducer(AppReducer, createInitialState(initialLocale));
