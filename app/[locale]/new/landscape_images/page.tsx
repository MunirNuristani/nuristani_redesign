...
export default function NewLandscapeImagesPage() {
    ...
    <>
      <section className="page-hero">
        ...
        <div className="wrap">
          ...
          <h1>{phrases.landscapeTitle[lang]}</h1>
        </div>
      </section>
        ...
        <div className="gallery-grid">
          {urls.map((url, i) => (
            <div className="gallery-item" key={i} onClick={() => setSelected(url)}>
              <Image src={url} alt={`Landscape image ${i + 1}`} width={400} height={300} sizes="220px" style={{ width: "100%", height: "auto" }} />
            </div>
          ))}
        </div>
      </div>
