...
const ALL_LABEL: Record<string, string> = { en: "All eras", prs: "همه دوره‌ها", ps: "ټول دورونه", nr: "" };
  ...
  return (
    <>
      <section className="page-hero">
        ...
        <div className="wrap">
          <p className="kicker">{figures.length} {phrases.historicalFiguresTitle[lang]}</p>
