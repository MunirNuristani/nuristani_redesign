...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Download the Kalasha Ala Keyboard — the official Nuristani language keyboard for Android, iOS, Windows, and macOS. Type in Nuristani script with ease on all your devices.",
    keywords: [
    ...
    openGraph: {
      ...
      type: "website",
      images: [{ url: "/logo_original_noLabel.png", width: 1200, height: 630, alt: "Kalasha Ala Nuristani Keyboard" }],
    },
    twitter: {
