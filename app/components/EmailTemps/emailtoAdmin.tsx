...
<body class="body">
    <div dir="rtl" class="es-wrapper-color">
        <!--[if gte mso 9]>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-m-txt-c">
                                                                                        <h1 style="line-height: 120%;">${body.Name}</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-spacer es-p20" style="font-size:0">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p20t es-p20b es-p15r es-m-p0r">
                                                                                        <p>${body.Message}</p>
                                                                                        <p><br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" class="esd-block-text">
                                                                                        <p style="text-align: center;">reply to: ${body.Email}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
